...
peakSummits750bpFlank <- peakSummits + 750
...
saveRDS(list(peaks = peakSummits, counts = binList, umap = salmon_umap_1), 
        paste0("/mnt/orca/projects/AQUA-FAANG/ChIP/Salmon/", args[7]))
